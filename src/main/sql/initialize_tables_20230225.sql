...
CREATE TABLE IF NOT EXISTS games (
    ...
    CONSTRAINT games_FK FOREIGN KEY (thumbnail_id) REFERENCES thumbnails(id)
    );
...
ALTER TABLE game_calender.games 
    ...
    MODIFY COLUMN thumbnail_id DATE COMMENT 'Foreign key reference to thumbnails table, 1-1 relation';
...
ALTER TABLE game_calender.screen_shots
	...
	MODIFY COLUMN game_id INT COMMENT 'This is a foreign key reference to games id to connect the tables 1-many relation';